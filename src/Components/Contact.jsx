...
const Contact = () => {
  ...
  return (
    <div
      ref={contactRef}
      className='w-[90%] lg:w-[80%] xl:w-[50%] h-[200px] mx-auto mt-40 sm:mt-32 md:mt-36 lg:mt-32 xl:mt-40 4xr:mt-52 dark:border-purple-400 border-purple-600 border-2 mb-4 opacity-0 transition-opacity duration-700 shadow-xl'
    >
      <div className='py-10'>

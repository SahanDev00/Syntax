        ...
        <div className='w-full h-[250px] lg:h-[350px] xl:mt-6'>
          <div className='lg:grid lg:grid-cols-2 h-full w-full'>
            <div className=' p-4 border-2 border-white lg:border-0 shadow-lg shadow-purple-600 lg:shadow-none mt-6 hover:scale-105 lg:hover:scale-100 duration-300 ease-in-out'>
              ...
              <p className='text-xl xl:mr-[5%] text-white/80 dark:text-gray-400 xl:text-2xl 4xr:text-3xl'>Elevate your digital experience with a <span className='font-semibold text-white'>MERN STACK</span> web application featuring <span className='font-semibold text-white'>Modern UIs, Web APIs and Immersive 3D Models</span>. Syntaxware Solutions design visually stunning, interactive, and user-friendly interfaces that captivate your audience, boost engagement, and enhance your online presence.</p>
            </div>
            <div className=''>
